        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Start component tombol refresh--}}
                    <livewire:tombol-refresh />
                    {{-- <div class="m-2 flex gap-2">
                        <button disabled type="button" class="py-2.5 px-5 me-2 gap-1 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center">
                            Refresh
                    ...
                    {{-- End component tombol refresh--}}

                    {{-- Start card list galeri component --}}
                    ...
                    {{-- End card list galeri component --}}
